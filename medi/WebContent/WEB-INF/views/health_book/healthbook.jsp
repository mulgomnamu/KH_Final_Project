	...
	<div class="login"><!-- 2뎁스명 클래스 -->
		...
		<section id="sub_section">
			...
			<div class="title-type01">
				  <p class="m_txt"><strong>${login.id }</strong>님의 건강관리를 도와드리겠습니다!</p>
   			</div>
			<!-- content 시작 -->
			<div class="content"> 
          ...
          <tbody>
			...
			<tr>
				<th scope="row"><label for="inp1">신장&nbsp;:</label></th>
				<td>
					<input type="text" name="height" id="height" size="8" value="" maxlength="4" onkeydown="return numberOnly2(event);"> cm
				</td>
			</tr>
