...
<c:if test="${login.seq eq health.seq}">
    ...
    <ul class="bh_4u_vital_t_ul">
        <li class="bh_4u_vital_t_body">
            <div class="bh_4u_inner">
                ...
                <div class="bh_4u_m">
                    <span class="ico_middle"><img src="../images/sub/ico_middle_1.gif" alt=""></span>
        ...
        <li class="bh_4u_vital_t_bmi">
            <div class="bh_4u_inner">
                ...
                <div class="bh_4u_m">
                    <span class="ico_middle"><img src="../images/sub/ico_middle_2.gif" alt=""></span>
    ...
    <ul class="vitalList">
        <li class="vitalList1">
            <div>
                <strong class="vitalTit">체중/체질량 기간 추이</strong>
        ...
        <li class="vitalList2">
            <div>
                <strong class="vitalTit">걸음 기간 추이</strong>
